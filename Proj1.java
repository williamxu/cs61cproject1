...
public class Proj1 {
	...
	public static class Map1 extends
		...
		public void setup(Context context) {
			targetGram = context.getConfiguration().get("targetWord")
					.toLowerCase();
			try {
		...
		private Func funcFromNum(int funcNum) {
			...
			case 2:
				func = new Func() {
					public double f(double d) {
						return d == Double.POSITIVE_INFINITY ? 0.0 : 1.0 + Math
								.sqrt(d);
					}
				};
				break;
	...
	public static class Reduce2 extends
		...
		/*
		 * Your output should be a in the form of (DoubleWritable score, Text
		 * word) where score is the co-occurrence value for the word. Your
		 * output should be sorted from largest co-occurrence to smallest
		 * co-occurrence.
		 */
		@Override
